...
/**
 * PostgreSQL PDO database access classes
 *
 * @package objSQL
 * @version 3.9.0
...
class obj_connection extends obj_access
{
    ...
    protected function obj_db_connection()
    {
        ...
        if ( $obj_port )
        {
            $obj_DSN = "pgsql:host={$this->obj_datasource[1]};port=$obj_port;dbname={$this->obj_datasource[4]}";
        }
		else
        {
            $obj_DSN = "pgsql:host={$this->obj_datasource[1]};dbname={$this->obj_datasource[4]}";
        }
    ...
    {
		$obj_get_info = explode( ';', $this->obj_connection->getAttribute( constant( 'PDO::ATTR_SERVER_INFO' ) ) );
		$obj_get_encoding = explode( ':', $obj_get_info[1] );

		return [$this->obj_connection->getAttribute( constant( 'PDO::ATTR_SERVER_VERSION' ) ), $obj_get_encoding[1], $this->obj_datasource[4]];
    }
...
class obj_resultset
{
   ...
   /**
    ...
    {
		$num_rows = $this->obj_result->rowCount();
...
/* EOF pdo_driver.php */
/* Location: ./drivers/pgsql/pdo_driver.php */