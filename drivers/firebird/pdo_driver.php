...
/**
 * Interbase/Firebird PDO database access classes
 *
 * @package objSQL
 * @version 3.9.0
...
class obj_connection extends obj_access
{
    ...
    {
        $obj_connection = new PDO( "firebird:host={$this->obj_datasource[1]};dbname={$this->obj_datasource[4]}", $this->obj_datasource[2], $this->obj_datasource[3] );
    ...
    {
		$obj_get_ver = explode( ',', $this->obj_connection->getAttribute( constant( 'PDO::ATTR_SERVER_VERSION' ) ) );

		return [str_replace( 'version ', '', $obj_get_ver[1] ), 'N/A', $this->obj_datasource[4]];
    }
...
class obj_transaction
{
    ...
    public function __construct( $connection )
    {
        ...
        //turn off autocommit
		$this->obj_connection->setAttribute( PDO::ATTR_AUTOCOMMIT, 0 );
        $this->obj_trans_object = $this->obj_connection->beginTransaction();
	}
    ...
    {
		$this->obj_connection->commit();

		return $this->obj_connection->setAttribute( PDO::ATTR_AUTOCOMMIT, 1 );
	}
...
/* EOF pdo_driver.php */
/* Location: ./drivers/firebird/pdo_driver.php */